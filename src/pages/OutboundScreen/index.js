...
class index extends React.Component {
    ...
    getData = async () => {
        ...
        if (tab === 1) {
            const array = await this.getDataList("chuKu") || [];
    ...
    render() {
        ...
        console.log("queryDataList6666", queryDataList)
                    ...
                    <View style={{flexDirection: 'row'}}>
                        <View style={{flex: 1}}>
                            <Button style={{fontSize: 10}}
                                    onPress={() => this.props.navigation.navigate('OutCargo', {})}>信息库</Button>
                        </View>
                        <View style={{flex: 1}}>
                            <Button style={{fontSize: 10}}
